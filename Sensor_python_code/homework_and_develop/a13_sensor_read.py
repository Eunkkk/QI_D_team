...
def main_process(): 
    for i in range(0,5):                            #alpha_sensor
        ...
        elif i == 1: print "NO2 value is {0}".format(sensor_value[i])#no2
        elif i == 2: print "O3 value is {0}".format(sensor_value[i])#o3
        elif i == 3: print "CO value is {0}".format(sensor_value[i])#CO
        elif i == 4: print "SO2 value is {0}\n".format(sensor_value[i])#So2    
        time.sleep(delay)
